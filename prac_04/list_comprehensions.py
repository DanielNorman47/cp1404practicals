...
# join all last names together with ", " between them, if their full name length is > 11
string_of_long_names = ", ".join([name.split(" ")[1] for name in full_names if len(name) > 11])
print(string_of_long_names)